# -*- coding: utf-8 -*-
#
# TrueNTH Shared Services documentation build configuration file, created by
# sphinx-quickstart on Wed Apr 27 11:18:56 2016.
#
...
try:
    ...
    # Fallback metadata when the distribution is not installed
    metadata = {
...
# RTD docs appear to build successfully even if sphinx_rtd_theme is imported
