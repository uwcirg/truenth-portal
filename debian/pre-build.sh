...
# version generated by setuptools_scm
# setuptools_scm includes current datetime as version suffix if local changes exist
...
# ignore updates to changelog file to prevent "dirty" version numbers (indicating local changes)
