...
def upgrade():
    ...
    op.add_column(u'users', sa.Column('is_active', sa.Boolean(), server_default='1', nullable=False))
    op.add_column(u'users', sa.Column('password', sa.String(length=255), nullable=True))
    op.add_column(u'users', sa.Column('reset_password_token', sa.String(length=100), nullable=True))
