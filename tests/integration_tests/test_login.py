...
class TestLogin(IntegrationTestCase):
    ...
    def test_consent_after_login(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Continue to TrueNTH'])[1]/following::div[9]").click()
        driver.find_element_by_id("next").click()
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='The Urology Clinic at Harborview'])[1]/following::label[1]").click()
