...
var __i18next = window.__i18next = (function() {
    function init(options, callback) {
        ...
        i18next.use(i18nextXHRBackend) /* global i18next i18nextXHRBackend */
            .init({
                ...
                missingKeyHandler: function(lng, ns, key, fallbackValue) {
                    if (options.missingKeyHandler) {
                        options.missingKeyHandler(lng, ns, key, fallbackValue);
                    }
                },
                ...
                backend: {
                    ...
                    ajax: function(url, options, callback, data, cache) {
                        ...
                        try {
                            ...
                            console && console.log(e); /*global console */
                        }
                    }
                }
            }, function(err, t) {
