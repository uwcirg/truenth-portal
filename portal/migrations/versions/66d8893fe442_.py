...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['code_id'], ['codeable_concepts.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.add_column(u'observations', sa.Column('audit_id', sa.Integer()))
    op.create_foreign_key('observations_audit_fk', 'observations', 'audit', ['audit_id'], ['id'])
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('observations_audit_fk', 'observations', type_='foreignkey')
