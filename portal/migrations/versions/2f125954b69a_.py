...
def upgrade():
    ...
    def purge_newer_of(id1, id2):
        assert id1 not in purge_ids
        assert id2 not in purge_ids
        purge_ids.add(max(id1, id2))

    # ### commands auto generated by Alembic - please adjust! ###
    def compare_docs(left_id, left_doc, right_id, right_doc):
        ...
        if not any((added, removed, modified)):
            ...
            purge_newer_of(left_id, right_id)
        else:
            if added:
    ...
    for r in results:
        ...
        while keys:
            ...
            compare_docs(left_id, left_doc, right_id, right_doc)
