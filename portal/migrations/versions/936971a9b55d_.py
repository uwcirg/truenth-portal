...
def upgrade():
    ...
    sa.UniqueConstraint('reference_txt', 'codeable_concept_id', name='_reftxt_codeable_concept')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('observation_id', 'performer_id', name='_obs_performer')
    )
