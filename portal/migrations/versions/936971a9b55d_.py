...
def upgrade():
    ...
    op.create_table('performers',
                    ...
                    sa.Column('reference_txt', sa.Text(), nullable=False),
                    ...
                    sa.UniqueConstraint(
                        'reference_txt', 'codeable_concept_id', name='_reftxt_codeable_concept')
                    )
    op.create_table('observation_performers',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('observation_id', sa.Integer(), nullable=False),
                    sa.Column('performer_id', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['observation_id'], [
                        'observations.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['performer_id'], ['performers.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('observation_id', 'performer_id',
                                        name='_obs_performer')
                    )
