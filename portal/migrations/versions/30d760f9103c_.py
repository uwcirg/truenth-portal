...
def upgrade():
    ...
    op.add_column('questionnaire_responses', sa.Column('questionnaire_bank_id', sa.Integer(), nullable=True))
    op.create_foreign_key('qnr_qb_id_fkey', 'questionnaire_responses', 'questionnaire_banks', ['questionnaire_bank_id'], ['id'])
