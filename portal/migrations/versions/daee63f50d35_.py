...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['questionnaire_response_id'], ['questionnaire_responses.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('patient_id', 'questionnaire_response_id', name='_research data_unique_patient_qnr')
    )
    op.create_index(op.f('ix_research_data_authored'), 'research_data', ['authored'], unique=False)
    op.create_index(op.f('ix_research_data_instrument'), 'research_data', ['instrument'], unique=False)
    op.create_index(op.f('ix_research_data_patient_id'), 'research_data', ['patient_id'], unique=False)
    op.create_index(op.f('ix_research_data_questionnaire_response_id'), 'research_data', ['questionnaire_response_id'], unique=False)
    op.create_index(op.f('ix_research_data_research_study_id'), 'research_data', ['research_study_id'], unique=False)
